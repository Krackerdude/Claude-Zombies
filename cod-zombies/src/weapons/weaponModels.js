...
const CLASS_SOCKETS = {
  ...
  assaultRifle: { gripR: [0, -0.115, 0.06], gripL: [0, -0.16, -0.4],      mag: [0, -0.11, -0.14],  shell: [0.035, 0.02, -0.06] },
  hmg:          { gripR: [0, -0.115, 0.07], gripL: [0, -0.16, -0.42],     mag: [0, -0.12, -0.05],  shell: [0.04, 0.02, -0.06] },
  shotgun:      { gripR: [0, -0.115, 0.08], gripL: [0, -0.16, -0.3],      mag: [0, -0.05, -0.2],   shell: [0.035, 0.03, -0.04] },
  sniper:       { gripR: [0, -0.115, 0.06], gripL: [0, -0.16, -0.36],     mag: [0, -0.11, -0.05],  shell: [0.035, 0.03, -0.05] },
